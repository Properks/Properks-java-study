...
/**
 * <a href="https://github.com/TheAlgorithms/Java/blob/master/src/main/java/com/thealgorithms/sorts/SortUtils.java">출처</a>
 */
public class SortUtils {
     ...
     */
    public static <T> void swapWithClassType(T[] array, int i, int j) {
        if (i != j) {
    ...
    public static void swapWithBasicType(int[] array, int i, int j) {
        if (i != j) {
    ...
    public static <T> void swapWithList(List<T> array, int i, int j) {
        if (i != j) {
    ...
    public static <T extends Comparable<T>> void flip(T[] array, int left, int right) {
        while (left <= right) {
            swapWithClassType(array, left++, right--);
        }
    }

    /**
     * Checks whether the array with basic type is sorted in ascending order.
     *
